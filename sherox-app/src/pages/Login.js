          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <span className="text-gray-700 font-semibold">Trusted by 500,000+ Women</span>
              </motion.div>
              ...
              >
                Empowering women with <strong>AI-powered safety features</strong>, real-time protection, and instant emergency response. Join thousands who trust SHEROX for their daily security.
              </motion.p>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  <p className="text-gray-600">Sign in to your SHEROX account</p>
                </motion.div>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 0.4, duration: 0.6 }}
                  >
                    <label className="block text-gray-700 font-semibold mb-3">Email or Phone</label>
                  ...
                  >
                    <label className="flex items-center cursor-pointer group">
                      ...
                      />
                      <span className="ml-3 text-gray-700 group-hover:text-gray-900 transition-colors">Remember me</span>
                    </label>
                    <Link 
                      to="/forgot-password" 
                  ...
                  {error && (
                    <motion.p
                      className="text-red-500 text-center text-sm bg-red-50 p-3 rounded-lg border border-red-200"
